...
const {
  ...
  commonAfterAll,
  u1Token,
  u2Token, // PART 3.3 added in to update test that were failing originally... sean wrote this
  adminToken,
  testJobIds, //^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
} = require("./_testCommon");
...
describe("POST /users", function () {
  ...
  //------------------PART 3.3 ADD TEST SEAN WROTE THIS//
